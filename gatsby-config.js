    ...
    softwareProjects: [
      {
        ...
        items: [
          { name: "TexMol", description: "Molecular visualization and computation" },
          { name: "VolumeRover", description: "Scalable Image Processing and Visualization Tool" },
          { name: "VolRoverN", description: "Geometric and electrophysiological neuronal simulation and visualization package" },
          { name: "LBIE", description: "Level Set Boundary-Interior-Exterior Meshing Tool" },
          { name: "Prism", description: "Geometric modeling using algebraic patches" },
      ...
      },
      {
        ...
        items: [
          { name: "MolSurf", description: "Molecular surface generation and manipulation" },
          { name: "MolEnergy", description: "Molecular energetics computation" },
          { name: "DPG", description: "Dynamic packing grids" },
          { name: "SSEP", description: "Secondary structure elucidation package" },
          { name: "Pocket/Tunnel", description: "Protein pocket/tunnel extractor" },
          { name: "QHM", description: "Quality Quadrilateral/Hexahedral Mesh Generator" },
          { name: "QTM", description: "Quality Triangular/Tetrahedral Mesh Generator" },
          { name: "QMDM", description: "Quality Multi-Domain Meshing with Gap" },
          { name: "QMDMNG", description: "Quality Multi-Domain Meshing with No Gap" },
          { name: "GPU Renderer", description: "Surface/Volume Rendering Packages" },
          { name: "Shastra", description: "X11 Based Scientific Toolkits" },
          { name: "Tracing/Tiling/Tetra", description: "Arbitrary Topology Shape Reconstruction Library from Planar Cross Sections" },
          { name: "PFCorr", description: "Polar Fourier Correlation" },
          { name: "PF2Fit", description: "Polar Fast Fourier Rigid-body Fitting" },
          { name: "PF3Fit", description: "Polar Fast Fourier Flexible Fitting" },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "ParIso", description: "Fast Parallel Isosurface Rendering Library" },
          { name: "MTD", description: "Server-Client based Multi-Tiled Display Library" },
